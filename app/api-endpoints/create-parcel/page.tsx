    ...
    <div className="max-w-5xl mx-auto">
      ...
      <Card className="mb-6">
        ...
        <h3 className="text-lg font-semibold mb-2 ">Link in api-playground:</h3>
          ...
          <p className="mb-4"><a href="https://apiplayground.shipsy.in/#post-/api/customer/integration/consignment/upload/softdata/v2" className="text-blue-500">https://apiplayground.shipsy.in/#post-/api/customer/integration/consignment/upload/softdata/v2</a></p>
